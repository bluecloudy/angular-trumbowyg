...
"use strict";angular.module("trumbowyg").run(["$templateCache",function(t){t.put("trumbowyg/../../../syncrospace/angular-trumbowyg/src/components/trumbowyg/trumbowyg..html",'<style media="screen">\n  trumbowyg {\n    display: block;\n  }\n</style>\n<div></div>\n')}]);
